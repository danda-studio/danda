...
export function ServicesBanner() {
  return (
    <section className="relative -mt-[2.75rem]">
      <div className="relative mx-auto h-[47.375rem] w-[87rem]">
        <img alt="" className="absolute block inset-0 size-full max-w-none" src="/landing/desktop-6/frame2147221825.svg" />
        <div className="absolute inset-0 overflow-clip rounded-[2rem]">
                ...
                <div className="absolute contents left-[1.68375rem] top-[2.20063rem]" data-node-id="375:1286">
                  <div className="-translate-x-1/2 absolute contents left-[calc(50%-0.16rem)] top-[4.07562rem]" data-node-id="375:1287">
                    ...
                    <div className="absolute flex h-[8.68163rem] items-center justify-center left-[7.11813rem] top-[7.2375rem] w-[13.945rem]" data-node-id="375:1289">
                      <div className="-scale-y-100 flex-none rotate-180">
                        <div className="h-[8.68163rem] relative w-[13.945rem]" data-name="Subtract">
                          <img alt="" className="absolute block inset-0 max-w-none size-full" src="/landing/desktop-6/subtract.svg" />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="-translate-x-1/2 absolute bg-white content-stretch drop-shadow-[0rem_2.25363rem_1.54481rem_var(--dd-border-subtle-strong)] flex flex-col gap-[0.43619rem] h-[6.25rem] items-start left-[calc(50%-5.69125rem)] p-[0.58156rem] rounded-[0.43619rem] top-[13.26313rem] w-[5.875rem]" data-node-id="375:1304" data-name="Component 2">
                    ...
                    <div className="h-[0.03488rem] relative shrink-0 w-[0.09963rem]" data-node-id="375:1313" data-name="Vector">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src="/landing/desktop-6/vector.svg" />
                    </div>
                    <div className="absolute left-[4.6125rem] size-[0.69431rem] top-[0.59813rem]" data-node-id="375:1314" data-name="Outline/Interface/Plus">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src="/landing/desktop-6/outline-interface-plus.svg" />
                    </div>
                    <div className="absolute flex items-center justify-center left-[3.78rem] size-[0.69431rem] top-[0.59813rem]" data-node-id="375:1315">
                      <div className="-rotate-90 flex-none">
                        <div className="relative size-[0.69431rem]" data-name="Outline/Interface/Settings-adjust">
                          <img alt="" className="absolute block inset-0 max-w-none size-full" src="/landing/desktop-6/outline-interface-settings-adjust.svg" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="absolute contents left-[12.12125rem] top-[2.20063rem]" data-node-id="375:1316">
                    ...
                    <div className="[word-break:break-word] absolute content-stretch flex flex-col font-(family-name:--font-inter-sans) font-medium gap-[0.69319rem] h-[4.35713rem] items-start leading-[1.5] left-[13.70563rem] not-italic text-[0.67506rem] text-white top-[2.79438rem] tracking-[-0.03038rem] w-[2.37663rem] whitespace-nowrap" data-node-id="375:1318">
                      ...
                      <p className="relative shrink-0" data-node-id="375:1320">
                        Light
                      </p>
                      <p className="relative shrink-0" data-node-id="375:1321">
                        Custom
                      </p>
                    </div>
                    ...
                    <div className="absolute inset-[19.23%_46.25%_79.35%_51.64%]" data-node-id="375:1324" data-name="Icon">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src="/landing/desktop-6/icon.svg" />
                    </div>
                    <div className="absolute flex h-0 items-center justify-center left-[12.12125rem] top-[7.74563rem] w-[7.5755rem]" data-node-id="375:1325">
                      <div className="flex-none rotate-180">
                        <div className="h-0 relative w-[7.5755rem]">
                          <div className="absolute inset-[-0.04938rem_0_0_0]">
                            <img alt="" className="block max-w-none size-full" src="/landing/desktop-6/line10.svg" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="absolute inset-[65.55%_12.96%_26.45%_80.19%]" data-node-id="375:1329" data-name="Icon">
                    <div className="absolute inset-[-3.12%_-3.7%]">
                      <img alt="" className="block max-w-none size-full" src="/landing/desktop-6/icon1.svg" />
                    </div>
                  </div>
                </div>
            ...
            <div className="-rotate-15 flex-none">
              <div className="bg-white h-[25rem] overflow-clip relative rounded-[1.5rem] shadow-[1rem_-0.8125rem_4.29375rem_0.3125rem_var(--dd-shadow-transparent)] w-[24.625rem]">
                ...
                <div className="absolute contents left-[0.97625rem] top-[0.6325rem]" data-node-id="375:1333">
                  <div className="absolute contents left-[9.57125rem] size-[12.82931rem] top-[3.7975rem]" data-node-id="375:1334">
                    <div className="absolute flex items-center justify-center left-[9.57125rem] size-[12.82931rem] top-[3.7975rem]" data-node-id="375:1335">
                      <div className="-rotate-2 flex-none">
                        <div className="border-4 border-solid border-white relative rounded-[2.5rem] size-[12.404rem]">
                          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[2.5rem] size-full" src="/landing/desktop-6/frame2136141696.png" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="absolute contents h-[16.61656rem] left-[1.51188rem] top-[0.6325rem] w-[18.50862rem]" data-node-id="375:1336">
                    <div className="absolute flex h-[16.61656rem] items-center justify-center left-[1.51188rem] top-[0.6325rem] w-[18.50862rem]" data-node-id="375:1337">
                      <div className="flex-none rotate-[-18.35deg]">
                        <div className="border-4 border-solid border-white h-[12.404rem] relative rounded-[2.5rem] w-[15.38644rem]">
                          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[2.5rem] size-full" src="/landing/desktop-6/frame2136141698.png" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="absolute contents h-[16.28237rem] left-[2.29063rem] top-[2.1625rem] w-[19.26219rem]" data-node-id="375:1338">
                    <div className="absolute flex h-[16.28237rem] items-center justify-center left-[2.29063rem] top-[2.1625rem] w-[19.26219rem]" data-node-id="375:1339">
                      <div className="flex-none rotate-15">
                        <div className="border-4 border-solid border-white h-[12.404rem] relative rounded-[2.5rem] w-[16.61806rem]">
                          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[2.5rem] size-full" src="/landing/desktop-6/frame2136141695.jpg" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute h-[3.34519rem] left-[0.97625rem] top-[12.5075rem] w-[3.12669rem]" data-node-id="375:1346">
                    <div className="absolute inset-[-1.1%_-1.17%]">
                      <img alt="" className="block max-w-none size-full" src="/landing/desktop-6/vector577.svg" />
                    </div>
                  </div>
                  <div className="absolute flex h-[4.22963rem] items-center justify-center left-[20.03063rem] top-[5.0075rem] w-[3.98788rem]" data-node-id="375:1347">
                    <div className="-scale-y-100 flex-none rotate-158">
                      <div className="h-[3.375rem] relative w-[2.9375rem]">
                        <div className="absolute inset-[-1.09%_-1.25%]">
                          <img alt="" className="block max-w-none size-full" src="/landing/desktop-6/vector578.svg" />
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="absolute flex inset-[66.67%_26.41%_23.85%_64.87%] items-center justify-center" data-node-id="375:1348" style={{ containerType: "size" }}>
                  <div className="flex-none h-[hypot(-30.6748cqw,96.5926cqh)] rotate-15 w-[hypot(96.5926cqw,21.8379cqh)]">
                    <div className="relative size-full" data-name="Icon">
                      <div className="absolute inset-[-3.12%_-3.7%]">
                        <img alt="" className="block max-w-none size-full" src="/landing/desktop-6/icon2.svg" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="absolute top-[42.125rem] left-[28.6875rem] flex items-center justify-center gap-[0.5rem]">
