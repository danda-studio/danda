  ...
  return (
    <>
      ...
      <div className="absolute top-[260.875rem] left-1/2 h-[31.25rem] w-[89.875rem] -translate-x-1/2 overflow-clip">
        ...
        <div className="absolute top-[calc(50%+8.625rem)] right-[1.5rem] h-[14rem] w-[21.125rem] -translate-y-1/2 bg-gradient-to-r from-[var(--dd-fade-black-transparent)] to-[43.023%] to-black" />
      </div>
    </>
  );
}
