export function Footer() {
  return (
    <>
      ...
      <div className="absolute contents left-[-0.5rem] top-[401.875rem]" data-node-id="375:1427" data-name="Danda">
        ...
        <div className="absolute contents h-[5.58194rem] left-[29.5rem] top-[404.6875rem] w-[19.89738rem]" data-node-id="375:1433">
          <div className="absolute flex h-[5.58194rem] items-center justify-center left-[29.5rem] top-[404.6875rem] w-[19.89738rem]" data-node-id="375:1434">
            <div className="flex-none rotate-[-4.85deg]">
              <div className="bg-[var(--dd-blue-600)] h-[3.9375rem] relative rounded-[1rem] w-[19.63494rem]" />
            </div>
          </div>
          <div className="absolute flex h-[3.66206rem] items-center justify-center left-[31.0525rem] top-[405.48438rem] w-[16.94244rem]" data-node-id="375:1435">
            <div className="flex-none rotate-[-4.85deg]">
              <p className="[word-break:break-word] font-(family-name:--font-inter-sans) font-semibold leading-[1.135] not-italic relative text-[2rem] text-white tracking-[-0.09rem] whitespace-nowrap">danda@gmail.com</p>
            </div>
          </div>
        </div>
        <div className="absolute contents h-[6.23563rem] left-[41.9375rem] top-[408.375rem] w-[19.43581rem]" data-node-id="375:1436">
          ...
          <div className="absolute flex h-[4.19075rem] items-center justify-center left-[43.5425rem] top-[409.365rem] w-[16.217rem]" data-node-id="375:1438">
            <div className="flex-none rotate-7">
              <p className="[word-break:break-word] font-(family-name:--font-inter-sans) font-semibold leading-[1.135] not-italic relative text-[var(--dd-gray-450)] text-[2rem] tracking-[-0.09rem] whitespace-nowrap">Обсудить проект</p>
            </div>
          </div>
        </div>
      </div>
      <div className="-translate-x-1/2 absolute backdrop-blur-[0.87906rem] bg-[var(--dd-glass-tint)] border-[0.06169rem] border-[var(--dd-border-subtle)] border-solid content-stretch flex gap-[0.41125rem] items-center justify-center left-[calc(50%-8.69625rem)] p-[0.41125rem] rounded-[1.645rem] top-[375.125rem]" data-node-id="375:1502" data-name="btn">
      ...
      <div className="absolute bg-[var(--dd-blue-600)] content-stretch flex gap-[1rem] items-center justify-center left-[49.5625rem] pl-[0.625rem] pr-[1.5rem] py-[0.625rem] rounded-[1.25rem] top-[392.25rem]" data-node-id="375:1509" data-name="btn">
        ...
        <p className="[word-break:break-word] font-(family-name:--font-manrope-sans) font-medium leading-[1.1] relative shrink-0 text-[1.25rem] text-white tracking-[-0.025rem] whitespace-nowrap" data-node-id="375:1512">
          Бесплатный аудит
        </p>
      </div>
        ...
        <div className="content-stretch flex flex-col gap-[1.5rem] h-[13.25rem] items-end relative shrink-0 w-full" data-node-id="375:1514" data-name="content">
          <div className="[word-break:break-word] content-stretch flex flex-col h-[5.0625rem] items-start relative shrink-0 w-full" data-node-id="375:1515" data-name="get in touch">
            <div className="content-stretch flex flex-col gap-[0.625rem] h-[10.4375rem] items-start relative shrink-0 w-[22.8125rem] whitespace-nowrap" data-node-id="375:1516" data-name="mail">
              <p className="font-(family-name:--font-manrope-sans) font-medium leading-[1.2] relative shrink-0 text-[var(--dd-gray-400)] text-[1.25rem] tracking-[-0.0625rem]" data-node-id="375:1517">{`Напишите нам `}</p>
              <p className="font-(family-name:--font-manrope-sans) font-bold leading-[0] relative shrink-0 text-[3.25rem] text-black text-center tracking-[-0.0975rem]" data-node-id="375:1518">
                <span className="leading-none text-[var(--dd-blue-600)]">@</span>
                <span className="leading-none">danda</span>
              </p>
            </div>
            <p className="font-(family-name:--font-manrope-sans) font-medium leading-[1.2] min-w-full relative shrink-0 text-[var(--dd-gray-400)] text-[1.25rem] tracking-[-0.0625rem] w-[min-content]" data-node-id="375:1519">
          ...
          <div className="absolute content-stretch flex flex-col items-start left-[78.75rem] top-[-0.0625rem] w-[8.25rem]" data-node-id="375:1520" data-name="menu">
            <div className="[word-break:break-word] content-stretch flex flex-col font-(family-name:--font-manrope-sans) font-medium gap-[1.75rem] items-start leading-[1.2] relative shrink-0 text-[1.25rem] tracking-[-0.0625rem] w-[7.4375rem]" data-node-id="375:1521" data-name="navigation">
              <p className="min-w-full relative shrink-0 text-[var(--dd-gray-400)] w-[min-content]" data-node-id="375:1522">
                Навигация
              </p>
              <div className="content-stretch flex flex-col gap-[1rem] items-start relative shrink-0 text-[var(--dd-gray-820)] w-[7.8125rem] whitespace-nowrap" data-node-id="375:1523" data-name="navigation">
